  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-center">
        ...
        <button class="px-6 py-3 text-white font-semibold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg shadow-lg hover:scale-105 duration-200 hover:drop-shadow-2xl hover:shadow-[#7dd3fc] hover:cursor-pointer">
