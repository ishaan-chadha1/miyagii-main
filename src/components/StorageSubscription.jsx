        ...
        <div>
          ...
          >
            <span className="text-black">
              We at <span className="text-[#5379FE]">miyagi</span> offer 4 plans{" "}
              <br /> of varying storages
            </span>
          </h2>
        </div>
      </div>
      ...
      >
        <div className="w-[250px] h-[220px] md:h-[520px] xl:h-[570px] p-6 flex flex-col gap-4 md:gap-6">
          ...
          <div className="flex flex-col gap-5">
            ...
            <input type="radio" name="checkbox" class="check" id="radio4" />
            <label for="radio4">
              <div class="container">
                <div class="cRadioBtn"></div>
              </div>
          ...
          <div className="w-[250px] h-[440px] md:h-[520px] xl:h-[570px] bg-blue-500 rounded-3xl p-6 flex flex-col justify-between">
            <div className="flex flex-col gap-4 md:gap-6">
              ...
              <div className="flex flex-col gap-5">
                ...
                <p className=" text-slate-200 text-[0.9rem] md:text-base leading-relaxed">
                  For The Golf Professionals Who Already Have Many Teaching
                  Hours
                </p>
              </div>
            </div>
