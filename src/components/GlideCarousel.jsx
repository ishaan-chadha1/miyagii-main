        ...
        <ul className="glide__slides">
          ...
          <li className="glide__slide flex items-center justify-center p-6">
            <div className="text-center space-y-4">
              {" "}
              {/* This div wraps your text content */}
              ...
              <p className="text-[#807E87] text-base">
                ...
                scanning, and mailing documents. Welcome to the future of
                secure, efficient, and tamper-proof document signing with
          ...
          <li className="glide__slide flex items-center justify-center p-6">
            <div className="text-center space-y-4">
              {" "}
              {/* This div wraps your text content */}
              <h1 className="text-[#5379FE] text-2xl font-bold">Store Data</h1>
              <p className="text-[#807E87] text-base">
          ...
          <li className="glide__slide flex items-center justify-center p-6">
            <div className="text-center space-y-4">
              ...
              <p className="text-[#807E87] text-base">
                ...
                with Blockchain-powered document verification ensure
                authenticity and trust while bidding farewell to counterfeiting
                concerns.
              </p>
            </div>
          </li>
          <li className="glide__slide flex items-center justify-center p-6">
            <div className="text-center space-y-4">
              ...
              <p className="text-[#807E87] text-base">
                Lorem ipsum Lorem ipsum Lorem ipsumLorem ipsumLorem ipsumLorem ipsumLorem ipsum Lorem ipsum Lorem ipsum Lorem ipsumLorem ipsum 
              </p>
            </div>
          </li>
          <li className="glide__slide flex items-center justify-center p-6">
